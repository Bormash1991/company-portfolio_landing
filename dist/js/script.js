...
/* harmony import */ var _modules_showMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/showMenu */ "./src/js/modules/showMenu.js");
...
window.addEventListener("DOMContentLoaded", () => {
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])(".service__slider-wrapper", 3, true, false, true, ".service__slider-control", "service__slider-item_active", {
    320: {
      items: 1,
      slideBy: 1
    },
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])(".promo__slider-inner", 1, true, false, true, ".promo__slider-control", "");
  Object(_modules_showMenu__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _closeModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./closeModal */ "./src/js/modules/closeModal.js");


const modal = () => {
  const close = document.querySelectorAll("[data-close]");
  close.forEach(item => {
    item.addEventListener("click", _closeModal__WEBPACK_IMPORTED_MODULE_0__["default"]);
  });
};
...
/***/ "./src/js/modules/modals_checkWidth.js":
/*!*********************************************!*\
  !*** ./src/js/modules/modals_checkWidth.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (checkWidth);
...
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service */ "./src/js/modules/service.js");
/* harmony import */ var _modals_checkWidth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modals_checkWidth */ "./src/js/modules/modals_checkWidth.js");
/* harmony import */ var _showModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./showModal */ "./src/js/modules/showModal.js");
/* harmony import */ var _closeModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./closeModal */ "./src/js/modules/closeModal.js");
...
const sendForm = () => {
  const service = new _service__WEBPACK_IMPORTED_MODULE_1__["default"](),
        forms = document.querySelectorAll("form"),
        inputs = document.querySelectorAll("input"),
        content = document.querySelector(".modal__title"),
        scroll = Object(_modals_checkWidth__WEBPACK_IMPORTED_MODULE_2__["default"])();
  ...
  const showThanksModal = message => {
    Object(_showModal__WEBPACK_IMPORTED_MODULE_3__["default"])(".modal", scroll);
    content.textContent = message;
    setTimeout(() => {
      content.textContent = "";
      Object(_closeModal__WEBPACK_IMPORTED_MODULE_4__["default"])();
    }, 5000);
  };
  ...
  forms.forEach(item => {
    item.addEventListener("submit", e => {
      ...
      postData(JSON.stringify(formObj)).then(() => {
...
class Service {
  constructor() {
    _defineProperty(this, "_apiBase", "http://localhost:3000");

    _defineProperty(this, "sendData", async (url, data) => {
    ...
    _defineProperty(this, "sendForms", async data => {
      return await this.sendData("/forms/", data);
    });

    _defineProperty(this, "sendEmail", async data => {
...
const showMenu = () => {
  ...
  menu.addEventListener("click", e => {
    ...
    if (window.getComputedStyle(header).position == "fixed" && (target.nodeName == "A" || target.parentNode.classList.contains("menu__item"))) {
      toggleMenu();
    }
  });
};
...
const slider = (containerSelector, counter, loopSelector, auto, centerSelector, controlSelector, activeSelector, responsive = "") => {
  const sl = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])({
  ...
  const customSlider = () => {
    const custom = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])({
